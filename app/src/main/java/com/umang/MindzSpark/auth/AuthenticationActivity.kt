...
class AuthenticationActivity : AppCompatActivity() {
    ...
    private val hardcodedEmail = "aryan@example.com"
    private val hardcodedPassword = "aryan123"
...
//        hardcodedSignInButton.setOnClickListener {
//            hardcodedSignIn() // Hardcoded Login
//        }
//
//        private fun hardcodedSignIn() {
//            val hardcodedUsername = "testuser"
//            val hardcodedPassword = "password123"
//
//            // Mock authentication logic
//            if (hardcodedUsername == "testuser" && hardcodedPassword == "password123") {
//                // Simulate successful sign-in
//                Log.d("SignIn", "Hardcoded user signed in successfully")
//                handleHardcodedUserSignIn(hardcodedUsername)
//            } else {
//                // Authentication failed
//                Log.d("SignIn", "Hardcoded user authentication failed")
//                Toast.makeText(this, "Invalid hardcoded credentials", Toast.LENGTH_SHORT).show()
//            }
//        }
//
//        private fun handleHardcodedUserSignIn(username: String) {
//            // Proceed with authenticated user flow
//            Log.d("SignIn", "Welcome, $username!")
//            // Navigate to the next screen or save user details
//        }
